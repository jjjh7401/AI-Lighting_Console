"""실기 쓰기 — Sequence 8 에 VerifyA 곡 큐 8개를 세운다."""
...
class OperatorDelegatedApproval:
    ...
    발사 전에 전부 인쇄해 확인했고, 대상은 비어 있는 Sequence 8 하나뿐이다."""
...
approver = OperatorDelegatedApproval(allowed_sequence=8)
...
try:
    ...
    b = build_songcue_bundle("VerifyB4x", sel, sequences_section=seqs, groups_section=groups)
