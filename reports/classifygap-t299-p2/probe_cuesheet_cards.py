"""t299 Phase 2 — 큐시트 반영 한 번에 승인 카드가 몇 장 뜨는가.
...
실행:  uv run python reports/classifygap-t299-p2/probe_cuesheet_cards.py
"""
...
def main() -> None:
    ...
    tmp = Path(tempfile.mkdtemp(prefix="t299p2-cuesheet-"))
