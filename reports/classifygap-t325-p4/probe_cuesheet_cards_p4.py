"""t325 Phase 4 — 큐시트 반영 한 번에 승인 카드가 몇 장 뜨는가.
...
실행:  uv run python reports/classifygap-t325-p4/probe_cuesheet_cards_p4.py
"""
...
def main() -> None:
    ...
    tmp = Path(tempfile.mkdtemp(prefix="t325p4-cuesheet-"))
