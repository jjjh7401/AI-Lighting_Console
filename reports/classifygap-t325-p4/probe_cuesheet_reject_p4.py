"""t325 Phase 4 — 카드 한 장을 **거절**하면 콘솔에 0건 나가는가.
...
실행:  uv run python reports/classifygap-t325-p4/probe_cuesheet_reject_p4.py
"""
...
def main() -> None:
    ...
    tmp = Path(tempfile.mkdtemp(prefix="t325p4-reject-"))
