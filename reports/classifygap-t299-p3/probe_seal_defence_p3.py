"""t299 Phase 3 — `SEAL_DEFENCE` 귀속을 **재서** 표를 채운다.
...
실행:  uv run python reports/classifygap-t299-p3/probe_seal_defence_p3.py
"""
...
def main() -> None:
    ...
    for name, drive, _kind in SITES:
        tmp = Path(tempfile.mkdtemp(prefix="t299p3-seal-"))
