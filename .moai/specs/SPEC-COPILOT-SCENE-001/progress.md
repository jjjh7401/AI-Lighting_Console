...
| **⑦ 조사·어미 사본 그물** | ①이 fx↔scene `_ENDINGS` 동치 가드를 세웠다. 남은 것: `_PARTICLES`가 **fx·scene·looks 3벌인데 오늘 우연히 동일**(교훈 16의 형태). 기존 그물은 fx↔looks **단방향 행동 테스트 1건**뿐이고 **scene 사본은 무그물** | 작다 · 라이브 불필요 |
