...
문서 상태: draft (v0.8.0, 2026-08-23 — PASS-WITH-DEBT 0.87 채무 정리: 고아 포인터 재조준 · AC-030 ③ 미커버 열거 보강 · 뮤테이션 전제 확인 추가) · **Tier L · 통과 임계 0.85** · AC **20건**(전부 오프라인 · 그중 AC-021은 조건부). 본 문서는 spec.md의 요구를 관측 가능한 Given-When-Then 기준으로 전개한다. 요구(GEARS)는 spec.md가 소유하며 여기서 되풀이하지 않는다.
