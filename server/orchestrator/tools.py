    ...
    definitions = (
        ...
        ToolDefinition(
            ...
            description=(
                ...
                "operator's request does not match any shipped entry ('팬은 "
                "천천히 틸트는 빠르게', 'red-white 스트로브 느낌으로 4스텝', "
                "'현재 위치에서 살짝 도는 원'). Prefer find_fx + instantiate_fx "
                ...
                "absolute values. Use for '현재 위치에서', '지금 상태 유지하며'.\n"
                ...
                "exactly one. Use speed_master when the operator wants tempo "
                "control from a fader ('마스터에 물려줘', '템포 따라가게').\n"
                ...
                "/Universal (the operator asked for a preset, a '.프리셋에 "
                "저장', or wants to reuse the effect across songs). Numbers "
