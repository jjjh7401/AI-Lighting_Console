...
When the Stage-2 Tauri shell spawns this backend as a sidecar it needs two facts
back, and it may not obtain either one over a socket: the deny-all Rust scan
