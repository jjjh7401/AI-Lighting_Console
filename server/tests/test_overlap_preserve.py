...
class TestLintDeferralsDidNotGrow:
    ...
    **줄어드는 것이 눈에 보인다**는 점이다. 그 가시성을 사람 눈에 맡기면 유예는
    ...
    #: E501 을 234→35 로 줄여 70 → 국면 3(별표 임포트를 명시 임포트로)이 F403 4건·
    #: F405 49건을 없애 62 → 국면 4a(안전 자동수정)가 I001 16·UP009 11·E401 9·F401 4·
    #: SIM300 1 을 없애 30 → 국면 4b(수동)가 B007 9·B905 5·E741 6·SIM115 1 을 없애 22.
    #: 남은 세 규칙은 UP031·E501·E402 이고, 그중 E402 는 sys.path.insert 구조가 요구하는
    #: 결과라 이 기제가 남아 있는 한 지울 수 없다(.moai/reports/t337/phase4a.md §4).
    #: 유예를 줄일 때마다 이 값을 같이 낮춘다 —
